CREATE TABLE [PreEvaluate].[OptionRelationshipConditionSet] (
    ...
    CONSTRAINT [fk_OptionRelationshipConditionSet_OptionRelationshipCondition] FOREIGN KEY ([VehicleOptionRelationshipConditionId]) REFERENCES [PreEvaluate].[OptionRelationshipCondition] ([VehicleOptionRelationshipConditionId])
);
