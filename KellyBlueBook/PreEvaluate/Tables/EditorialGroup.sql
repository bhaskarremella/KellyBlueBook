CREATE TABLE [PreEvaluate].[EditorialGroup] (
    ...
    CONSTRAINT [fk_EditorialGroup_EditorialContent] FOREIGN KEY ([ContentId]) REFERENCES [PreEvaluate].[EditorialContent] ([ContentId])
);
