CREATE TABLE [PreEvaluate].[ConversionSetItem] (
    ...
    CONSTRAINT [fk_ConversionSetItem_ConversionSet] FOREIGN KEY ([ConversionSetId]) REFERENCES [PreEvaluate].[ConversionSet] ([ConversionSetId])
);
