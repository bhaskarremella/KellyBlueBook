CREATE TABLE [dbo].[OptionRelationshipCondition] (
    ...
    CONSTRAINT [fk_OptionRelationshipCondition_OptionRelationship] FOREIGN KEY ([VehicleOptionRelationshipId]) REFERENCES [dbo].[OptionRelationship] ([VehicleOptionRelationshipId])
);
