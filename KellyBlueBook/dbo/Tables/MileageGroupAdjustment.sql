CREATE TABLE [dbo].[MileageGroupAdjustment] (
    ...
    CONSTRAINT [fk_MileageGroupAdjustment_MileageRange] FOREIGN KEY ([MileageRangeId]) REFERENCES [dbo].[MileageRange] ([MileageRangeId])
);
