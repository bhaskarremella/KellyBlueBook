CREATE TABLE [dbo].[OptionRelationshipSet] (
    ...
    CONSTRAINT [fk_OptionRelationshipSet_OptionRelationship] FOREIGN KEY ([VehicleOptionRelationshipId]) REFERENCES [dbo].[OptionRelationship] ([VehicleOptionRelationshipId])
);
