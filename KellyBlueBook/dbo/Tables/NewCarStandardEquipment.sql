CREATE TABLE [dbo].[NewCarStandardEquipment] (
    ...
    CONSTRAINT [fk_NewCarStandardEquipment_VehicleOption] FOREIGN KEY ([VehicleOptionId]) REFERENCES [dbo].[VehicleOption] ([VehicleOptionId])
);
